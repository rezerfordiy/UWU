...
public class AppCompatRadioButton extends RadioButton implements androidx.core.widget.v, v0.f1 {
    ...
    public AppCompatRadioButton(Context context, @c.k0 AttributeSet attributeSet) {
    ...
    public AppCompatRadioButton(Context context, @c.k0 AttributeSet attributeSet, int i4) {
