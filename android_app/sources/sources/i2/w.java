...
public class w extends d0 {
    ...
    public void P(float f4) {
        ...
        float f5 = -1.0f;
        if (this.f8184x == 0) {
            float f6 = ((f4 * 6.0f) / 10.0f) + 20.0f + 0.5f;
            if (f6 < 40.0f) {
                f5 = f6;
            }
        }
        if (f5 > 0.0f) {
            Date date = new Date();
            date.setTime((long) (new Date().getTime() + ((64.0f - f5) * 24.0f * 60.0f * 60.0f * 1000.0f)));
            ...
            this.f8186z = d.f8064e.getResources().getString(identifier) + ": " + str2;
