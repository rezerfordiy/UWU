...
public class y extends d0 {
    ...
    public void P(float f4) {
        ...
        float f5 = -1.0f;
        if (this.f8190x == 0) {
            float f6 = (((f4 / 10.0f) + 0.1f) / 0.14f) + 0.5f;
            if (f6 < 40.0f) {
                f5 = f6;
            }
        }
        if (f5 > 0.0f) {
            ...
            this.f8192z = d.f8064e.getResources().getString(identifier) + ": " + str2;
