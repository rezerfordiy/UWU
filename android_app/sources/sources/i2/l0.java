...
public class l0 extends d0 {
    ...
    public void N(Canvas canvas) {
        ...
        float fM = M();
        P(fM);
        String str = d.f8064e.getResources().getString(R.string.human_td) + ": " + decimalFormat.format(fM) + "mm";
    ...
    public void P(float f4) {
        ...
        float f5 = -1.0f;
        if (this.f8149x == 0) {
            float f6 = ((f4 * 37.21f) / 10.0f) + 39.7f;
            if (f6 >= 50.0f && f6 <= 285.0f) {
                f5 = f6;
            }
        }
        if (f5 > 0.0f) {
            Date date = new Date();
            date.setTime((long) (new Date().getTime() + ((285.0f - f5) * 24.0f * 60.0f * 60.0f * 1000.0f)));
            ...
            this.f8151z = d.f8064e.getResources().getString(identifier) + ": " + str2;
