...
public class y6 extends j6 {
    ...
    public class b extends Thread {
        ...
        public void run() {
            ...
            while (!this.f14196b) {
                ...
                if (this.f14197c == 0) {
                    this.f14197c = System.currentTimeMillis();
                } else if (System.currentTimeMillis() - this.f14197c > 1000) {
                    y6 y6Var = y6.this;
                    if (y6Var.O == 0) {
                        y6Var.g1((byte) 3);
                        y6.this.e1(true);
    ...
    public void I() {
        ...
        if (bArr != null) {
            ...
            if (b4 == 2) {
                if (this.f14195l0 == null) {
                    b bVar2 = new b();
                    this.f14195l0 = bVar2;
                    bVar2.b(System.currentTimeMillis());
                    this.f14195l0.start();
                }
            } else if (b4 == 1 && (bVar = this.f14195l0) != null) {
                bVar.a(true);
                this.f14195l0 = null;
            }
            i0(this.f13442t);
    ...
    public Map<String, v> K() {
        if (this.f13432j == null) {
            ...
            this.f13432j = map;
            map.put("UX-8HA", new v(512, 192, 32));
