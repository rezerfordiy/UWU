...
public class b extends Socket {
    ...
    public static class a extends SocketImpl {
        ...
        @Override // java.net.SocketImpl
        public void bind(InetAddress inetAddress, int i4) throws IOException {
            throw new UnsupportedOperationException();
        }
        ...
        @Override // java.net.SocketImpl
        public void connect(String str, int i4) throws IOException {
            throw new UnsupportedOperationException();
        }

        @Override // java.net.SocketImpl
        public void create(boolean z3) throws IOException {
            throw new UnsupportedOperationException();
        }
        ...
        @Override // java.net.SocketImpl
        public void connect(InetAddress inetAddress, int i4) throws IOException {
            throw new UnsupportedOperationException();
        }
