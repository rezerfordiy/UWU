...
public class f {
    ...
    public static final /* synthetic */ boolean f9224r = false;
    ...
    public int f9232h = 24;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public float[] f9233i = new float[256];

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public float[] f9234j = new float[256];

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public boolean f9235k = false;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public boolean f9236l = false;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public int f9237m = 0;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public ArrayList<byte[]> f9238n = new ArrayList<>();

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public byte[] f9239o = null;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public ArrayList<byte[]> f9240p = new ArrayList<>();

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public byte[] f9241q = null;
    ...
    */
    public byte[] f(byte[] r11, int r12, int r13, int r14, int r15) {
        ...
        L67:
            ...
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: n2.f.f(byte[], int, int, int, int):byte[]");
    }

    public byte[] g(byte[] bArr, int i4, int i5, int i6, int i7) {
        byte[] bArr2 = this.f9241q;
    ...
    public final void j() {
        ...
        for (int i4 = 0; i4 < 256; i4++) {
            ...
            this.f9233i[i4] = (float) Math.cos(d4);
            this.f9234j[i4] = (float) Math.sin(d4);
        }
    }
    ...
    public byte[] o(byte[] bArr, int i4, int i5, int i6, int i7, int i8) {
        ...
        if (this.f9238n.size() > 0 && this.f9238n.get(0).length != length) {
            this.f9238n.clear();
        }
        this.f9238n.add(bArr2);
        while (this.f9238n.size() > 5) {
            this.f9238n.remove(0);
        }
        if (this.f9238n.size() < 5) {
            return bArr;
        }
        int i11 = i8 == 0 ? 1 : 2;
    ...
    public byte[] p(byte[] bArr, int i4, int i5, int i6, int i7, int i8) {
        ...
        if (this.f9240p.size() > 0 && length != this.f9240p.get(0).length) {
            this.f9240p.clear();
        }
        this.f9240p.add(bArr2);
        while (this.f9240p.size() > 5) {
            this.f9240p.remove(0);
        }
        if (this.f9240p.size() < 5) {
            return bArr;
        }
        byte[] bArr3 = new byte[i9];
        System.arraycopy(bArr, 0, bArr3, 0, i9);
    ...
    public byte[] s(byte[] bArr, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        int i16 = 0;
        while (i16 < i8) {
            System.arraycopy(bArr2, i14, bArr3, i14, length);
            int i17 = i14;
            while (i17 < i12) {
                int i18 = i6;
                while (i18 <= i13) {
                    ...
                    while (i19 <= i17 + i15) {
                        if (i19 >= 0 && i19 < i12) {
                            for (int i21 = i18 - i15; i21 <= i18 + i15; i21++) {
                                if (i21 >= i6 && i21 <= i13) {
                                    int i22 = (i19 * 256) + i21;
                                    if (i22 < length2) {
                                        bArr4[i20] = bArr3[i22];
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public byte[] v(byte[] r19, int r20, int r21, int r22, int r23, int r24, int r25) {
        /*
            Method dump skipped, instruction units count: 202
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: n2.f.v(byte[], int, int, int, int, int, int):byte[]");
    }
    ...
    public byte[] x(byte[] bArr, byte[] bArr2, int i4, int i5, int i6, int i7, int i8) {
        ...
        int i12 = i11;
        byte[] bArrG = this.f9236l ? G(bArr, this.f9237m) : bArr;
        int i13 = this.f9229e;
        if (i13 == 1) {
            i9 = 3;
            i10 = 2;
        ...
        if (this.f9231g) {
            bArrG = c(bArr, bArr2, i4, i5, this.f9232h);
        }
        byte[] bArr3 = bArrG;
        if (this.f9225a) {
            int i16 = i6 / 2;
            ...
            return this.f9226b ? k(bArrL, i12, 512, i6, i7) : bArrL;
        }
        int i18 = i6 / 2;
        int i19 = i7 / 2;
    ...
    public byte[] z(byte[] bArr, byte[] bArr2, int i4, int i5, int i6, int i7, int i8) {
        ...
        if (this.f9225a) {
            ...
            return this.f9226b ? m(bArrN, i12, 512, i6, i7) : bArrN;
        }
        int i18 = i6 / 2;
        int i19 = i7 / 2;
