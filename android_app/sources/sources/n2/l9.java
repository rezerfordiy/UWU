...
public class l9 extends m1 {
    ...
    public l9(String str) {
        super(str);
        if (str.startsWith("UX-5CA ")) {
            A("WAP");
            p1.a aVar = this.f9527g;
            aVar.f9531b = 45.0f;
            aVar.f9532c = 0.85346603f;
            aVar.f9533d = false;
            aVar.f9535f = 128;
            aVar.f9536g = 512;
